...
CFLAGS=$(echo "-O2 -I/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/include -fdiagnostics-color=always -Wno-format-security" | sed "s#^$prefix#$prefix_real#")
VERSION="3.6"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
...
SO=".cpython-36-x86_64-linux-gnu.so"
PYTHONFRAMEWORK=""
