...
am_rel_srcdir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/automake-1.16.1'
am_top_srcdir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/automake-1.16.1'
am_top_builddir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/automake-1.16.1/.x86_64-pc-linux-gnu'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/share/automake-1.16/am'
    am_automake_acdir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/share/aclocal-1.16'
    am_bindir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/bin'
    am_datadir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/share'
    am_docdir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/share/doc/automake'
    am_pkgvdatadir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/share/automake-1.16'
    am_scriptdir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/share/automake-1.16'
    am_system_acdir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/share/aclocal'
    ;;
  no)
...
PERL=${AM_TESTSUITE_PERL-${PERL-'/bin/perl'}}
...
if test $AM_TESTSUITE_SIMULATING_NO_CC_C_O = no; then
  CC=${AM_TESTSUITE_CC-${CC-'/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/bin/host-gcc'}}
else
  CC=$am_testaux_builddir/cc-no-c-o
fi
CXX=${AM_TESTSUITE_CXX-${CXX-'/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/bin/host-g++'}}
F77=${AM_TESTSUITE_F77-${F77-'false'}}
FC=${AM_TESTSUITE_FC-${FC-'false'}}
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/include -fdiagnostics-color=always -Wno-format-security'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/include -fdiagnostics-color=always -Wno-format-security'}}
...
if test $AM_TESTSUITE_SIMULATING_NO_CC_C_O = no; then
  GNU_CC=${AM_TESTSUITE_GNU_CC-${GNU_CC-'/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/bin/host-gcc'}}
else
  GNU_CC=$am_testaux_builddir/cc-no-c-o
fi
GNU_CC=${AM_TESTSUITE_GNU_CC-${GNU_CC-'/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/bin/host-gcc'}}
GNU_CXX=${AM_TESTSUITE_GNU_CXX-${GNU_CXX-'/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/bin/host-g++'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/include -fdiagnostics-color=always -Wno-format-security'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/include -fdiagnostics-color=always -Wno-format-security'}}
