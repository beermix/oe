...
srcdir='/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/make-4.2.1'
CC='/usr/bin/gcc'
...
CPPFLAGS=''
LDFLAGS='-Wl,--export-dynamic -Wl,-rpath,/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/lib -L/home/user/-f2fs/oe/build.OE-Generic.x86_64-9.0-devel/toolchain/lib -s'
ALLOCA=''
LOADLIBES='-ldl   '
eval extras=\'\'
REMOTE='stub'
