...
PKG_CMAKE_OPTS_HOST="-DBUILD_SHARED_LIBS=ON -DENABLE_NLS=OFF -DYASM_BUILD_TESTS=OFF"
                     
PKG_CMAKE_OPTS_TARGET="-DBUILD_SHARED_LIBS=OFF -DENABLE_NLS=OFF -DYASM_BUILD_TESTS=OFF"
