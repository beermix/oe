...
post_unpack() {
  sed -i -e "s|-flto |-flto=4 |g" $PKG_BUILD/configure
  sed -i -e "s|-flto |-flto=4 |g" $PKG_BUILD/configure.ac
  sed -i -e "s|testCongestion|disabled_&|" $PKG_BUILD/Lib/test/test_socket.py
} 
