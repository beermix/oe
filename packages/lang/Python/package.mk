...
PKG_DEPENDS_TARGET="toolchain sqlite expat zlib bzip2 openssl libffi gdbm Python:host"
PKG_SECTION="lang"
...
PKG_CONFIGURE_OPTS_TARGET="ac_cv_file_dev_ptc=no \
                           ...
                           --with-system-ffi \
                           --with-system-expat \
                           --with-cxx-main=x86_64-openelec-linux-gnu-c++"
post_patch() {
...
make_host() {
  make PYTHON_MODULES_INCLUDE="$HOST_INCDIR" \
       ...
       PYTHON_DISABLE_MODULES="_sqlite3 readline _curses _curses_panel $PY_DISABLED_MODULES"
