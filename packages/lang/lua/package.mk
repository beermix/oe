...
make_target() {
  ...
  make BUILD_CC="$HOST_CC" CC="$CC" LD="$LD" CFLAGS="$CFLAGS -fPIC -DPIC" LUA_CFLAGS="-Wall -fPIC -DLUA_USE_POSIX" LUA_MYLIBS="-lreadline -lhistory -lncurses" LUA_CFLAGS="-DLUA_USE_READLINE" -C $ROOT/$PKG_BUILD/src all
}
