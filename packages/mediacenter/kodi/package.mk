...
PKG_DEPENDS_TARGET="toolchain kodi:host kodi:bootstrap xmlstarlet:host Python zlib systemd pciutils dbus lzo pcre swig:host libass curl fontconfig fribidi tinyxml openjpeg freetype libcdio libdvdnav taglib libxml2 libxslt sqlite ffmpeg crossguid giflib opengl lcms2 libfmt libpng yajl rapidjson libdvdnav libhdhomerun"
PKG_DEPENDS_HOST="toolchain"
PKG_DEPENDS_BOOTSTRAP="toolchain lzo:host libpng:host openjpeg:host giflib:host"
