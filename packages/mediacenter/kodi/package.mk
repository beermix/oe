...
PKG_DEPENDS_TARGET="toolchain kodi:host xmlstarlet:host libsquish boost Python zlib bzip2 systemd pciutils lzo pcre swig:host libass curl rtmpdump fontconfig fribidi tinyxml libjpeg-turbo libpng tiff freetype jasper libcdio libmpeg2 taglib libxml2 libxslt yajl sqlite ffmpeg crossguid giflib dcadec flac"
...
# kodi should never be built with lto
  ...
  export CFLAGS="$CFLAGS -D_POSIX_C_SOURCE"
  export LIBS="$LIBS -lz -lssp -lterminfo"
