...
PKG_CMAKE_OPTS_HOST="-DCMAKE_BUILD_TYPE=Release -DZSTD_MULTITHREAD_SUPPORT=0 -DZSTD_LEGACY_SUPPORT=0 -DZSTD_BUILD_SHARED=0"
PKG_CMAKE_OPTS_TARGET="-DCMAKE_BUILD_TYPE=Release -DZSTD_MULTITHREAD_SUPPORT=1 -DZSTD_LEGACY_SUPPORT=0 -DZSTD_BUILD_SHARED=0"
