...
PKG_CMAKE_OPTS_HOST="-DZSTD_MULTITHREAD_SUPPORT=0 -DZSTD_BUILD_SHARED=0"

PKG_CMAKE_OPTS_TARGET="-DZSTD_MULTITHREAD_SUPPORT=1 -DZSTD_BUILD_PROGRAMS=0 -DZSTD_BUILD_SHARED=0 -DLZMA_SUPPORT=0 -DZSTD_ZLIB_SUPPORT=0"
