...
PKG_CMAKE_OPTS_HOST="-DCMAKE_BUILD_TYPE=Release -DTHREADS_PTHREAD_ARG=0 -DZSTD_BUILD_SHARED=0"
PKG_CMAKE_OPTS_TARGET="-DCMAKE_BUILD_TYPE=Release -DTHREADS_PTHREAD_ARG=1 -DZSTD_BUILD_SHARED=0"
