...
configure_package() {
  ...
  PKG_CMAKE_OPTS_HOST="-DBUILD_SHARED_LIBS=0 -DCMAKE_POSITION_INDEPENDENT_CODE=0 DCMAKE_BUILD_TYPE=Release"
  PKG_CMAKE_OPTS_TARGET="-DBUILD_SHARED_LIBS=0 -DCMAKE_POSITION_INDEPENDENT_CODE=0 DCMAKE_BUILD_TYPE=Release"
}
