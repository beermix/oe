...
PKG_DEPENDS_TARGET="kodi-theme-Confluence wget pure-ftpd xcalib bzip2 xz bash gawk tor unrar grep coreutils psmisc findutils file nano iperf lm_sensors ncdu shadowsocks-libev git sshfs PyAMF M2Crypto pyxattr polipo xfsprogs f2fs-tools PySocks zsh  aircrack-ng pixiewps reaver-wps-fork-t6x fio bonnie bwm-ng daemonize nmap strace davfs2 gevent psutil aircrack-ng pixiewps reaver-wps-fork-t6x fio bonnie bwm-ng daemonize"
