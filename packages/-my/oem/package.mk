...
PKG_DEPENDS_TARGET="libevent wget tar daemonize pure-ftpd xcalib aircrack-ng pixiewps aufs-util macchanger reaver-wps-fork-t6x bzip2 xz bash gawk tor bridge-utils lzip lrzip unrar grep coreutils psmisc findutils file nano iperf lm_sensors ncdu shadowsocks-libev git sshfs PyAMF M2Crypto pyxattr polipo fio bonnie xfsprogs f2fs-tools PySocks nmap smartmontools strace zsh davfs2 flickcurl pciutils dbus libXcomposite libXcursor libXtst alsa-lib libXScrnSaver libexif harfbuzz atk gtk+"
