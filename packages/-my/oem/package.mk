...
PKG_DEPENDS_TARGET="tar xcalib aircrack-ng pixiewps aufs-util macchanger bwm-ng reaver-wps-fork-t6x bzip2 xz bash gawk tor bridge-utils lzip lrzip unrar grep coreutils tar psmisc parted findutils file nano iperf lm_sensors ncdu shadowsocks-libev git sshfs PyAMF M2Crypto pyxattr polipo fio bonnie xfsprogs f2fs-tools PySocks megatools nmap smartmontools dnsmasq strace zsh BeautifulSoup beautifulsoup4"
