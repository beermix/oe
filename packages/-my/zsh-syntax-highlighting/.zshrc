...
# User configuration
export PATH="/root/.local/bin:/usr/local/sbin:root/.go/bin:/root/.samba/bin:/root/.samba/sbin:$PATH"
#export PATH="/root/.local:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/root/.samba/sbin:/root/.samba/bin:/root/go/bin:/root/.go/bin:/root/.local/bin"
