...
PKG_DEPENDS_TARGET="pciutils dbus libevent x11 libXcomposite libXcursor libXtst alsa-lib bzip2 yasm nss libXScrnSaver libexif libpng atk gtk+ intel-vaapi-driver libva-vdpau-driver unclutter xdotool libinput libxkbcommon libdrm libjpeg-turbo libxslt freetype harfbuzz re2 chromium:host"
PKG_SECTION="browser"
...
addon() {
  ...
  # gtk3
  # cp -ri $(get_build_dir gtk3)/.install_pkg/usr/ $ADDON_BUILD/$PKG_ADDON_ID/
