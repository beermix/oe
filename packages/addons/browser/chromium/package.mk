...
PKG_DEPENDS_TARGET="pciutils systemd dbus libXtst libXcomposite libXcursor unclutter alsa-lib bzip2 yasm nss libXScrnSaver libexif libpng atk xdotool libdrm libjpeg-turbo freetype libxslt harfbuzz gtk+ libxss re2 snappy libvpx chromium:host"
PKG_SECTION="browser"
...
# Possible replacements are listed in build/linux/unbundle/replace_gn_files.py ==     'enable_vulkan=false'
...
depends+=(${_system_libs[@]} freetype2 harfbuzz)
  ...
  noti ninja -j${CONCURRENCY_MAKE_LEVEL} $NINJA_OPTS -C out/Release chrome chrome_sandbox widevinecdmadapter
}
