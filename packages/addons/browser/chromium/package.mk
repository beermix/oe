...
PKG_DEPENDS_TARGET="toolchain pciutils dbus libXcomposite libXcursor libXtst alsa-lib bzip2 yasm libXScrnSaver libexif libpng harfbuzz atk gtk+ unclutter xdotool libva-vdpau-driver libvdpau ninja:host nss"
...
make_target() {
  ...
  ionice -c3 nice -n20 ninja -j5 -C out/Release chrome chrome_sandbox widevinecdmadapter
}
