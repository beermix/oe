...
make_target() {
  ...
  ionice -c3 nice -n20 ninja -j2 -C out/Release chrome chrome_sandbox chromedriver widevinecdmadapter
}
...
addon() {
  ...
  # atk
  #cp -PL $(get_pkg_build atk)/.install_pkg/usr/lib/libatk-1.0.so.0 $ADDON_BUILD/$PKG_ADDON_ID/lib
