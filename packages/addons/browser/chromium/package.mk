...
PKG_DEPENDS_TARGET="chromium:host pciutils dbus libXcomposite libXcursor libXtst alsa-lib bzip2 yasm nss libXScrnSaver libexif libpng harfbuzz atk gtk2 unclutter xdotool libwebp re2"
PKG_SECTION="browser"
...
addon() {
  ...
  $STRIP $PKG_BUILD/out/Release/chrome
  ...
  # gtk2
  cp -PL $(get_pkg_build gtk2)/.install_pkg/usr/lib/libgdk-x11-2.0.so.0 $ADDON_BUILD/$PKG_ADDON_ID/lib
  cp -PL $(get_pkg_build gtk2)/.install_pkg/usr/lib/libgtk-x11-2.0.so.0 $ADDON_BUILD/$PKG_ADDON_ID/lib
