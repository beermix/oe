...
addon() {
  ...
  # gtk3 gdk3
  cp -PL $(get_build_dir gtk3)/.$TARGET_NAME/gtk/.libs/libgailutil-3.so.* $ADDON_BUILD/$PKG_ADDON_ID/lib
  cp -PL $(get_build_dir gtk3)/.$TARGET_NAME/gtk/.libs/libgdk-3.so.* $ADDON_BUILD/$PKG_ADDON_ID/lib
