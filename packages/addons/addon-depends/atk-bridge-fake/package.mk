...
PKG_NAME="atk-bridge-fake"
PKG_VERSION="0.0.1"
PKG_SITE="http://library.gnome.org/devel/atk/"
PKG_URL="http://ftp.barfooze.de/pub/sabotage/tarballs/atk-bridge-fake-0.0.1.tar.xz"
...
make_target() {
  make CC="$CC" AR="$AR" LD="$LD" XCFLAGS="$CFLAGS" RANLIB="$RANLIB" XLDFLAGS="$LDFLAGS" CFLAGS="$CFLAGS" prefix=/usr -j1
}
