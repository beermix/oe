...
PKG_ARCH="any"
PKG_LICENSE="GPL"
PKG_SITE="http://ftp.acc.umu.se/pub/gnome/sources/atk/?C=M;O=D"
...
PKG_CONFIGURE_OPTS_TARGET="--enable-static --disable-shared --disable-rebuilds --enable-introspection=no"