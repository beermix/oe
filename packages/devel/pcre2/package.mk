...
PKG_CONFIGURE_OPTS_TARGET="--enable-utf8 --enable-pcre2-16 --enable-pcre2-32 --enable-unicode-properties --enable-pcregrep-libz --enable-pcregrep-libbz2 --enable-jit --enable-static"
