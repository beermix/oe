...
PKG_DEPENDS_TARGET="toolchain linux libmnl libnftnl libpcap libnetfilter_acct libnetfilter_conntrack libnetfilter_queue"
PKG_SECTION="network"
...
PKG_CONFIGURE_OPTS_TARGET="--enable-devel --with-kernel=$(kernel_path)"
