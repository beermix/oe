PKG_NAME="libnl-tiny"
PKG_VERSION="4225e93"
PKG_SHA256="d2b57597b234c84b113e7640064c3273616c0bf086ad223d71f49aaea086ad59"
...
#CC="$CC" CFLAGS="$optcflags" prefix="$butch_prefix"


#LIBNLTINY_MAKE_OPTS="CC=$CC AR=$AR RANLIB=$RANLIB CFLAGS=$CFLAGS prefix=/usr SHAREDLIB="
#PKG_MAKE_OPTS_TARGET="$LIBNLTINY_MAKE_OPTS"
#PKG_MAKEINSTALL_OPTS_TARGET="$LIBNLTINY_MAKE_OPTS"