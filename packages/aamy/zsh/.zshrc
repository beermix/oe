...
# User configuration
export PATH="/usr/bin:/usr/sbin:$PATH:$HOME/.bin"
...
alias his='history'
alias a2='aria2c --file-allocation=none --max-connection-per-server=8 --force-sequential=true --continue=false'
...
alias rmpyo='/usr/bin/find . -name "*.pyo" -exec rm -rf {} \;'
alias ds='docker search'
alias da='docker ps -a'
alias sz='du -hs'
alias n='nano'
alias logup='cat ~/.kodi/temp/kodi.log | pastebinit'
alias mowat='sshfs root@wat.is.my:/ /storage/50GS/wat.is.my -o password_stdin <~/passwd.txt'
...
alias mkdir='mkdir -p'
alias mowat='sshfs root@95.46.98.161:/ /storage/..Wat -o password_stdin <~/passwd.txt'
...
alias jj='journalctl -a | lnav'
alias grr='git reset --hard && git clean -dfx && git pull'
alias a2='aria2c --file-allocation=none --optimize-concurrent-downloads'
alias reb='sync;reboot'
alias mowat='sshfs -o reconnect,ServerAliveInterval=15 root@95.46.98.161:/ /storage/..Wat -o password_stdin <~/passwd.txt'
...
alias db='docker build -t t2h -f Dockerfile .'
alias mc='mc -u'
alias m='make'
alias cp='cp -r -i'
