...
[ "$BUILD_ANDROID_BOOTIMG" = "not" ] && PKG_DEPENDS_TARGET+=" mkbootimg:host"
[ "$SWAP_SUPPORT" = not ]            && KERNEL_EXTRA_CONFIG+=" swap"
[ "$NFS_SUPPORT" = not ]             && KERNEL_EXTRA_CONFIG+=" nfs"
[ "$SAMBA_SUPPORT" = yes ]           && KERNEL_EXTRA_CONFIG+=" samba"
[ "$BLUETOOTH_SUPPORT" = yes ]       && KERNEL_EXTRA_CONFIG+=" bluetooth"
[ "$UVESAFB_SUPPORT" = not ]         && KERNEL_EXTRA_CONFIG+=" uvesafb"
