...
PKG_URL=""
PKG_DEPENDS_TARGET="toolchain libc:init busybox:init linux:init psplash:init util-linux:init e2fsprogs:init dosfstools:init f2fs-tools:init xfsprogs:init"
