...
PKG_DEPENDS_HOST=""
PKG_DEPENDS_TARGET="toolchain busybox:host hdparm dosfstools e2fsprogs libtool zip unzip zlib xz pciutils usbutils parted gptfdisk findutils grep gawk bash less coreutils psmisc tar"
