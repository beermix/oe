...
PKG_DEPENDS_HOST=""
PKG_DEPENDS_TARGET="toolchain busybox:host hdparm dosfstools e2fsprogs zip unzip zlib xz pciutils usbutils parted procps-ng gptfdisk psmisc findutils grep gawk sed coreutils less tar bash"
