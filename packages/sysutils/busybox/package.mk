...
PKG_DEPENDS_HOST=""
PKG_DEPENDS_TARGET="toolchain busybox:host hdparm dosfstools e2fsprogs zip unzip unrar bzip2 pciutils usbutils parted procps-ng gptfdisk coreutils findutils sed grep less psmisc sysstat bash gawk"
