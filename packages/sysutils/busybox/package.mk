...
PKG_DEPENDS_HOST=""
PKG_DEPENDS_TARGET="toolchain busybox:host hdparm dosfstools e2fsprogs libtool zip unzip zlib pciutils usbutils parted gptfdisk findutils grep gawk bash less coreutils psmisc sed tar"
