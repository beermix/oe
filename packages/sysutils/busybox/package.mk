...
#  along with OpenELEC.  If not, see <http://www.gnu.org/licenses/>.    fbset time lrzip gperf nettle libarchive
################################################################################
...
PKG_DEPENDS_HOST=""
PKG_DEPENDS_TARGET="toolchain busybox:host hdparm dosfstools e2fsprogs libtool zip unzip zlib unrar pciutils usbutils parted procps-ng gptfdisk psmisc findutils grep gawk sed coreutils bash less tar libarchive"
