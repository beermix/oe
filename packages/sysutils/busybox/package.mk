...
PKG_DEPENDS_HOST=""
PKG_DEPENDS_TARGET="toolchain busybox:host hdparm dosfstools e2fsprogs libtool zip unzip bzip2 xz pciutils usbutils parted procps-ng gptfdisk findutils sed grep less psmisc sysstat bash gawk binutils"
