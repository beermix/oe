...
pre_configure_target() {
  export CFLAGS="$CFLAGS -fno-schedule-insns -fno-schedule-insns2 -Wno-format-truncation -fstack-protector-strong -mzero-caller-saved-regs=used implicit-function-declaration"
